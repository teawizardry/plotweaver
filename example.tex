...
Three feature boxes are specified using \texttt{tcolorbox}. They are \texttt{featureBox}, \texttt{leftBox}, \texttt{rightBox}, \texttt{calloutBox}, and \texttt{paperBox}. You can also use the command \texttt{statBox} to nicely align a left and right box. These boxes support upper and lower content, but you don't have to specify both.
