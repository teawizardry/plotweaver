...
You can make a character sheet using the \texttt{MakeCharacterSheet} command. Currently, this only prints a one page sheet, but more complex sheets are in the works. See \texttt{character\_sheet.tex} for an example of how to use this command.
