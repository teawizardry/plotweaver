...
\end{itemize}
\begin{description}
    \item[Hanging Subheading:] You can also use the \texttt{description} environment to create short subheadings with a hanging indent. See the \texttt{enumitem} package documentation for more details.
\end{description}
